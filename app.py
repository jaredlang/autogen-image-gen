...
if __name__ == "__main__":
    ...
    # message = """Generate weather forecast images for weather app UI design on android screen based on the following description: 
    # sunny sky with few clouds, low at 37 degree and high up to 72 degree
    # """
